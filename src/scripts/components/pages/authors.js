  ...
  if (array.length) {
    ...
    <div class="card" style="width: 18rem;">
      <div class="card-body">
        ...
        <hr>
        <!-- <i class="btn btn-danger fas fa-heart" id="fav-author-btn--${item.firebaseKey}"></i>-->
        ...
        <i class="btn btn-secondary fas fa-trash-alt" id="delete-author-btn--${item.firebaseKey}"></i>
      </div>
    </div>
    `;
    });
